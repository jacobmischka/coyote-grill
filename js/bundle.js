...
/***/ function(module, exports, __webpack_require__) {
	...
	showMenuButton.addEventListener('click', function (event) {
		...
		if (menu.classList.contains('collapsed')) {
			(0, _velocityAnimate2.default)(menu, 'slideDown', { display: 'flex', complete: function complete() {
					menu.classList.remove('collapsed');
				} });
		} else {
			(0, _velocityAnimate2.default)(menu, 'slideUp', { display: 'none', complete: function complete() {
