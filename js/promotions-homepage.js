...
function addCss() {
	...
	style.textContent = "\n\t.promotion-list-container[svelte-1884388730], [svelte-1884388730] .promotion-list-container {\n\t\tpadding: 2em 1em;\n\t\tfont-size: 1.25em;\n\t\ttext-align: center;\n\t}\n\n\t.promotion-list[svelte-1884388730], [svelte-1884388730] .promotion-list {\n\t\tdisplay: flex;\n\t\tjustify-content: flex-start;\n\t\talign-items: stretch;\n\t\toverflow-x: auto;\n\t\toverflow-y: hidden;\n\t\ttext-align: left;\n\t}\n\n\t.promotion[svelte-1884388730], [svelte-1884388730] .promotion {\n\t\tflex-grow: 1;\n\t\tflex-shrink: 0;\n\t\twidth: 300px;\n\t\tmax-width: calc(100% - 1em);\n\t\tposition: relative;\n\t\tpadding: 0;\n\t\tdisplay: block;\n\t\tborder-radius: 5px;\n\t\tbox-shadow: 0 2px 5px 2px rgba(0, 0, 0, 0.25);\n\t\tmargin: 1em;\n\t\tbackground-size: cover;\n\t\tbackground-position: center;\n\t\tcolor: white;\n\t\ttext-decoration: none;\n\t\topacity: 0.9;\n\t\tcursor: pointer;\n\t\tborder: none;\n\t\tborder-color: transparent;\n\t\toutline: none;\n\t\toutline-color: transparent;\n\t}\n\n\t.promotion[svelte-1884388730]:first-child, [svelte-1884388730] .promotion:first-child {\n\t\tmargin-left: 0.5em;\n\t}\n\n\t.promotion[svelte-1884388730]:last-child, [svelte-1884388730] .promotion:last-child {\n\t\tmargin-right: 0.5em;\n\t}\n\n\t.promotion[svelte-1884388730]:hover, [svelte-1884388730] .promotion:hover {\n\t\ttransform: scale(1.01);\n\t\tbox-shadow: 0 2px 5px 3px rgba(0, 0, 0, 0.25);\n\t\tcolor: white;\n\t\ttext-decoration: none;\n\t}\n\n\t.promotion-backdrop[svelte-1884388730], [svelte-1884388730] .promotion-backdrop {\n\t\tbox-sizing: border-box;\n\t\twidth: 100%;\n\t\theight: 100%;\n\t\tmargin: 0;\n\t\tpadding: 1em;\n\t\tbackground-color: rgba(0, 0, 0, 0.4);\n\t}\n\n\t.title[svelte-1884388730], [svelte-1884388730] .title {\n\t\tfont-size: 1.6em;\n\t\tfont-family: 'Oswald', sans-serif;\n\t}\n\n\t.desc[svelte-1884388730], [svelte-1884388730] .desc {\n\t\tfont-family: 'Lato', sans-serif;\n\t\tfont-weight: 300;\n\t}\n\n\tsmall[svelte-1884388730], [svelte-1884388730] small {\n\t\tdisplay: block;\n\t\tmargin: 2em 0;\n\t}\n";
...
function renderMainFragment(root, component) {
	...
	setAttribute(div, 'svelte-1884388730', '');
	div.className = "promotion-list-container";

	var h2 = createElement('h2');
	setAttribute(h2, 'svelte-1884388730', '');
	...
	setAttribute(div1, 'svelte-1884388730', '');
	...
	setAttribute(small, 'svelte-1884388730', '');
	...
	setAttribute(a, 'svelte-1884388730', '');
	a.href = "/promotions";
...
function renderEachBlock(root, eachBlock_value, promotion, promotion__index, component) {
	...
	setAttribute(span, 'svelte-1884388730', '');
	...
	setAttribute(p, 'svelte-1884388730', '');
	p.className = "desc";
